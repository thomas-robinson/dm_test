...
logical function send_5d (diag_data) 
  ...
  if (.not. allocated(obj%diag_data5d)) then
        allocate(obj%diag_data5d(size(diag_data,1),size(diag_data,2),size(diag_data,3),&
...
logical function send_4d (diag_data)
  real, dimension (:,:,:,:) :: diag_data
  if (.not. allocated(obj%diag_data4d)) then
        allocate(obj%diag_data4d(size(diag_data,1),size(diag_data,2),size(diag_data,3),&
                 size(diag_data,4)))
         obj%dim_of_data = 4
  endif
...
logical function send_3d (diag_data)
  real, dimension (:,:,:) :: diag_data
  if (.not. allocated(obj%diag_data3d)) then
        allocate(obj%diag_data3d(size(diag_data,1),size(diag_data,2),size(diag_data,3)))
         obj%dim_of_data = 3
  endif
...
logical function send_2d (diag_data)
  real, dimension (:,:) :: diag_data
  if (.not. allocated(obj%diag_data2d)) then
        allocate(obj%diag_data2d(size(diag_data,1),size(diag_data,2)))
         obj%dim_of_data = 2
  endif
...
logical function send_1d (diag_data)
  real, dimension (:) :: diag_data
  if (.not. allocated(obj%diag_data1d)) then
        allocate(obj%diag_data1d(size(diag_data,1)))
         obj%dim_of_data = 1
  endif
...
logical function send_0d (diag_data)
  real :: diag_data
  if (.not. allocated(obj%diag_data0d)) then
        allocate(obj%diag_data0d)
         obj%dim_of_data = 0
  endif
